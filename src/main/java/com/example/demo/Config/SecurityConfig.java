...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/categories/getCategory/{id}","api/users/isFavourite/{recipeId}","/getRecipe/{Id}","/recipes/category/{categoryId}","/recipes","/favourite_recipes","/profile","/main","/login","/registration","/api/ingredients","/api/categories", "/api/recipes/search","/api/recipes/getRecipe/{id}", "/a/login", "/a/registration", "/a/refresh_token").permitAll()
